...
import Block, { type BlockOption } from '../../unit/block';
...
const initState = (() => {
  ...
  const cur = lastRecord.cur as LastRecordCur;
...
const cur = (state = initState, action: ReducerAction) => {
  switch (action.type) {
